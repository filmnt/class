...
<br>
<button id="Link" onClick="document.getElementById('content').src = '과목1/note-1.pdf'" >판서노트-1</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = '과목1/note-2.pdf'" >판서노트-2</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = '과목1/note-3.pdf'" >판서노트-3</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = '과목1/note-4.pdf'" >판서노트-4</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = '과목1/note-5.pdf'" >판서노트-5</button>
<span></span>
