...
%% buttons %%
<span>
<button id="Link" onClick="document.getElementById('content').src = '과목2/seat.pdf'" >자리배치표</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = '과목2/textbook.pdf'" >교과서</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = '과목2/act.pdf'" > 학습지</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = '과목2/eval.pdf'" >형성평가</button>
<br>
<button id="Link" onClick="document.getElementById('content').src = '과목2/note-1.pdf'" >판서노트-1</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = '과목2/note-2.pdf'" >판서노트-2</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = '과목2/note-3.pdf'" >판서노트-3</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = '과목2/note-4.pdf'" >판서노트-4</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = '과목2/note-5.pdf'" >판서노트-5</button>
<span></span>
...
%% content %%
<div id="container">
<div><iframe id="content" src="수업/과목2/seat.pdf" width="100%" height="1200"  frameborder="0" allowtransparency="true" marginwidth="0" marginheight="0"></iframe></div>
<div class="error"></div>
</div>
