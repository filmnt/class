...
<span></span>
<button id="Link" onClick="document.getElementById('content').src = 'Subject-4/note-1.pdf'" >Note-1</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = 'Subject-4/note-2.pdf'" >Note-2</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = 'Subject-4/note-3.pdf'" >Note-3</button>
<span></span>
