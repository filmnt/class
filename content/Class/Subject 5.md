...
%% buttons %%
<span>
<button id="Link" onClick="document.getElementById('content').src = 'Subject-5/seat.pdf'" >자리배치표</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = 'Subject-5/textbook.pdf'" >교과서</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = 'Subject-5/act.pdf'" > 학습지</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = 'Subject-5/eval.pdf'" >형성평가</button>
<br>
