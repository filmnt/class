...
%% buttons %%
<span>
<button id="Link" onClick="document.getElementById('content').src = 'Subject-3/seat.pdf'" >Seat</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = 'Subject-3/textbook.pdf'" >Textbook</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = 'Subject-3/act.pdf'" > Task</button>
<span></span>
<button id="Link" onClick="document.getElementById('content').src = 'Subject-3/eval.pdf'" >Evaluation</button>
<br>
...
%% content %%
<div id="container">
<div><iframe id="content" src="Class/Subject-3/seat.pdf" width="100%" height="1200"  frameborder="0" allowtransparency="true" marginwidth="0" marginheight="0"></iframe></div>
<div class="error"></div>
</div>
